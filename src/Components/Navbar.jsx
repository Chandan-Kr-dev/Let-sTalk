...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="flex justify-between  sticky top-0 z-[999] py-2 w-full bg-slate-100 md:px-32 px-5 md:text-3xl text-sm "
    >
      ...
      <img className="md:h-20 h-10 invert" src="./logo-removebg-preview.png" alt="" />
      <div className="flex justify-center items-center md:gap-3 gap-1">
        {Username && LoggedIn && <h1 className="md:text-xl text-xs">Hii! {Username}</h1>}
        {LoggedIn ? (
          <button
