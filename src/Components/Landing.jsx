    ...
    <section className="h-[80vh] w-full bg-gradient-to-br from-slate-100 to-slate-200 px-20">
      <div className="flex justify-center items-center h-[80%] w-full ">
        <div className="left  h-full w-[50%] py-52">
          ...
          <button onMouseOver={()=>sethoverblog(true)} onMouseLeave={()=>sethoverblog(false)} className="hover:shadow-md hover:text-4xl transition-all rounded-lg  flex justify-center items-center gap-2 bg-gradient-to-tr from-yellow-100 to-yellow-200 px-2 py-1 mt-20 text-3xl">
